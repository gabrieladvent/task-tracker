...
import ActivityEntry, { formatActivityDay } from '@/Components/Activity/ActivityEntry';
import { TaskTimeline as TaskTimelineData } from '@/Pages/Periods/types/period';
    ...
    return (
        <div className="space-y-5">
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                <Chip label="Started" value={formatActivityDay(summary.first_task_date)} />
                <Chip
                    label="Age"
