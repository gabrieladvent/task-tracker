...
export default function ProjectDetail({ project, onClose }: Props) {
    ...
    const handleEdit = () => {
        onClose();
        // The parent component will handle reopening in edit mode
        setTimeout(() => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border-t border-gray-200 pt-6">
                <h4 className="text-sm font-semibold text-gray-700 mb-3">Project Color</h4>
                <div className="flex items-center gap-3">
                    <div
                        className="w-12 h-12 rounded-lg border-2 border-gray-200"
                        style={{ backgroundColor: projectColor }}
                    />
                    <span className="text-sm text-gray-600 font-mono">{projectColor}</span>
                </div>
            </div>
